                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      MyCheckBox(
                        text: 'Мени  каттоо  эсебинде  калтырыныз',
                      ),
                      // ignore: prefer_const_constructors
                      MyCheckBox(
                        text: 'Мага электрондук кат жөнөтүнүз',
                      ),
                      MyTextButton(
                        buttonName: 'Аккаунт түзүү',
                        onPressed: onSubmit,
